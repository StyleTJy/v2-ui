...
install_v2-ui() {
    ...
    echo -e ""
    curl -o /usr/bin/man-v2-ui -Ls https://raw.githubusercontent.com/StyleTJy/v2-ui/master/man-v2-ui.sh
    chmod +x /usr/bin/man-v2-ui
    echo -e "man-v2-ui 管理脚本使用方法: "
    echo -e "----------------------------------------------"
    echo -e "man-v2-ui                      - 显示管理菜单 (功能更多)"
    echo -e "man-v2-ui start                - 启动 v2-ui 面板"
    echo -e "man-v2-ui stop                 - 停止 v2-ui 面板"
    ...
    echo -e "man-v2-ui enable               - 设置 v2-ui 开机自启"
    echo -e "man-v2-ui disable              - 取消 v2-ui 开机自启"
    echo -e "man-v2-ui log                  - 查看 v2-ui 日志"
    echo -e "man-v2-ui update               - 更新 v2-ui 面板"
    echo -e "man-v2-ui install              - 安装 v2-ui 面板"
    echo -e "man-v2-ui uninstall            - 卸载 v2-ui 面板"
    echo -e "----------------------------------------------"
}
...
install_node(){
    ...
    wget -N --no-check-certificate -O /usr/local/v2-node.tar.gz https://github.com/StyleTJy/v2-ui/releases/download/${last_version}/v2-node.tar.gz
    if [[ $? -ne 0 ]]; then
